...
$parameter['application']['base_url']         = 'http://devadmin.thue.today/';
$parameter['application']['pagination_limit'] = 10;
// Application ---------

// --------- Asset
$parameter['asset']['url']      = 'http://devadmin.thue.today/asset/';
$parameter['asset']['home_url'] = 'http://dev.thue.today/asset/';
