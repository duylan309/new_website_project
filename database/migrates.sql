...
CREATE TABLE `thue_today`.`m_city` ( `city_id` INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY, `text_vi` VARCHAR(50) NOT NULL, `text_en` VARCHAR(50) NOT NULL, `created_at` TIMESTAMP NOT NULL);
...
ALTER TABLE `thue_today`.`m_category` CHANGE COLUMN `admin_user_id` `created_by` INT(11) NOT NULL  AFTER `status`
, DROP INDEX `url`
, ADD UNIQUE INDEX `slug` (`slug` ASC)
